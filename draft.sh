...
# camera and save file on host
# $FORMAT=mp4
# gst-launch-1.0 -e autovideosrc ! queue ! videoconvert ! $FORMAT. autoaudiosrc ! queue ! audioconvert ! $FORMAT. matroskamux name=$FORMAT ! filesink location=test.$FORMAT sync=false
